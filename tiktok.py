...
class zefoy:
    ...
    def __init__(self):
        ...
        options.binary_location = r"C:\Users\pc\PortableApps\GoogleChromePortable64\GoogleChromePortable.exe"  # Replace with the actual path
        self.driver = uc.Chrome(options=options, driver_executable_path=r"C:\Users\pc\PortableApps\GoogleChromePortable64\chromedriver.exe")  # Replace with the actual path
        ...
        self.real = 0
        self.xpaths = {
            "followers": "/html//div[6]/div/div[2]/div/div/div[2]/div/button",
            "hearts": "/html//div[6]/div/div[2]/div/div/div[3]/div/button",
            "comment_hearts": "/html//div[6]/div/div[2]/div/div/div[4]/div/button",
            "views": "/html//div[6]/div/div[2]/div/div/div[6]/div/button",
            "shares": "/html//div[6]/div/div[2]/div/div/div[7]/div/button",
            "favorites": "/html//div[6]/div/div[2]/div/div/div[8]/div/button",
        }
    ...
    def main(self):
        ...
        print()
        print(f"{Fore.WHITE} You have 15 seconds to complete the captcha")
        time.sleep(15)
        os.system(self.clear)
        ...
        print()
        print(self._print(f"{Fore.WHITE}MAKE SURE THERE IS NOTHING COVERING THE BUTTON BEFORE PASTING THE LINK!!! (Consider using an adblocker)"))
    ...
    def get_discord(self):
        try:
            ...
            return "https://discord.gg/sparklecare"
    ...
    def send_bot(self, search_button, main_xpath, vid_info, div):
        ...
        send_button = f'/html/body/div[{div}]/div/div/div/div/form/button'
        try:
            ...
            self.real += 1
            print(self._print(f"{Fore.WHITE}Send button not found, this is attempt number {self.real}."))
